...
public class jFrameLogin extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (identificador.isEmpty() || claveAcceso.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Debe ingresar usuario y contraseña.", "Error de Login", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            // **PASO CRUCIAL 1:** Intentamos obtener el objeto Usuario COMPLETO.
            // Esto verifica credenciales y carga todos los datos para la sesión.
            capa_modelo.Usuario usuarioLogeado
                    = userController.obtenerUsuarioPorCredenciales(identificador, claveAcceso);

            if (usuarioLogeado != null) {

                // **PASO CRUCIAL 2:** Guardamos el objeto completo en SesionActual.
                SesionActual.usuarioActual = usuarioLogeado;

                // Credenciales correctas: Se obtiene el cargo.
                String tipoCargo = SesionActual.usuarioActual.getTipoUsuario().getCargo().trim();
                JOptionPane.showMessageDialog(this, "Bienvenido, acceso como: " + tipoCargo);

                // 3. Redireccionar al usuario según su cargo (Rol)
            ...
            JOptionPane.showMessageDialog(this, "Error de conexión o base de datos: " + e.getMessage(), "Error Grave", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
